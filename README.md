...
This repository is part of the project SPED Brazil, specifically to generate the files related to EFD ICMS IPI. Code is in VBA and databse is MySQL. There is another repository for the data structure
